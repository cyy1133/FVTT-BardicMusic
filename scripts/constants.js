...
export const FALLBACK_LOCALIZATION = {
  en: {
    ...
    "BARDSONG.Config.Audience": "Audience",
    "BARDSONG.Config.Audience.all": "All connected players",
    "BARDSONG.Config.Audience.self": "Only me",
    "BARDSONG.Config.Channel": "Audio channel",
    "BARDSONG.Config.Volume": "Volume",
    "BARDSONG.Config.Loop": "Loop playback",
    "BARDSONG.Config.Fade": "Fade duration (ms)",
    "BARDSONG.Config.Preview": "Preview",
  ...
  ko: {
    ...
    "BARDSONG.Config.SourceHint": "Foundry 데이터 경로 또는 직접 접근 가능한 오디오 URL을 입력하세요.",
    ...
    "BARDSONG.Config.Audience": "재생 대상",
    "BARDSONG.Config.Audience.all": "접속 중인 모두",
    "BARDSONG.Config.Audience.self": "나만",
    "BARDSONG.Config.Channel": "오디오 채널",
    "BARDSONG.Config.Volume": "볼륨",
    "BARDSONG.Config.Loop": "반복 재생",
    "BARDSONG.Config.Fade": "페이드 시간(ms)",
    "BARDSONG.Config.Preview": "미리 듣기",
    "BARDSONG.Config.Picker": "찾아보기",
    "BARDSONG.Notify.MissingSource": "이 아이템에는 음악 경로가 설정되어 있지 않습니다.",
